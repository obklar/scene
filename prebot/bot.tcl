...
# And hell looot more.....
# Add the script to your eggs
# source scripts/bot.tcl
...
set mysql_(db) "pre_db"

# Self-Explanatory! Set .chanset for channels you want all these command enabled
# Use those commands on channel addpre
# .chanset #addpre +addpre
# .chanset #addpre +info
# .chanset #addpre +gn
# .chanset #addpre +nuke
# .chanset #addpre +modnuke
# .chanset #addpre +unnuke
# .chanset #addpre +delpre
# .chanset #addpre +undelpre
# .chanset #Fr3sh-p +addpre
# .chanset #channel +addold
# .chanset #channel +addfiles
# .chanset #Fr3sh-p +search

# Exemple of line
# [mars 23 21:11:39 ] <PRE> !addpre Marvels... TV-HD-X264
# [mars 23 21:11:41 ] <PRE> !gn Marvels... Action_Crime_Drama
# [mars 23 21:11:43 ] <PRE> !info Marvels... 76 3546.00
...
proc isy:addrelease { chan rlsname unixtime files size genre type } {
	...
	if {[channel get $chan $type]} {
		...
		switch $type {
			...
			"info" {
				set chanmsg "$rlsname $files $size"
			}
...
putlog "$script_version --> Loaded Succesfully!"
...
# It would be nice if you didn't delete this but there is really nothing I can do!
putlog "\002Pre Indexer \002 Loaded Succesfully!"
